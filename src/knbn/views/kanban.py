...
class KanbanView(Widget):
    ...
    BINDINGS = [
        ...
        Binding('ctrl+up', 'move_up', 'Promote', show=False, priority=True),
        Binding('ctrl+down', 'move_down', 'Demote', show=False, priority=True),
        Binding('ctrl+left', 'move_left', 'Move Left', show=False, priority=True),
        Binding('ctrl+right', 'move_right', 'Move Right', show=False, priority=True),
